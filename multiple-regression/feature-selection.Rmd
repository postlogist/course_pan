...
# Best lambda
cat("The minimal error is obtained with lamda =", cv_ridge$lambda.min, "\n\n")
...
# Best lambda
cat("The minimal error is obtained with lamda =", cv_lasso$lambda.min, "\n\n")
