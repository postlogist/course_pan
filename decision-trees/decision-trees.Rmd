...
```{r Построение ctree для двух предикторов, fig.height=7, fig.width=10}
...
```{r Построение c50 для двух предикторов, fig.height=8, fig.width=10}
